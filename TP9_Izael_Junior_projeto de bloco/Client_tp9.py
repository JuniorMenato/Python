...
def exibe_uso_memoria():
    ...
    pygame.draw.rect(tela, cinzaverde, (20, 150, larg, 40))
    larg = larg * mem.percent / 100
    pygame.draw.rect(tela, preto, (20, 150, larg, 40))
    total = round(mem.total / (1024 * 1024 * 1024), 2)
    texto_barra = "Uso de Memória (Total: " + str(total) + "GB) usada (" + str(mem.percent) + "%)"
    text = font.render(texto_barra, 1,cinza )
...
def exibe_uso_disco():
    ...
    pygame.draw.rect(tela, verde_claro, (20, 220, larg, 40))
    larg = larg * disco.percent / 100
    pygame.draw.rect(tela, verde_escuro, (20, 220, larg, 40))
...
def exibe_uso_cpu():
    ...
    for i in l_cpu_percent:
        ...
        texto = "Núcleo " + str(i) + "%"
        text = font.render(texto, 1, cinza)
